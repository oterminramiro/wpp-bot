						...
						<tr>
							<td align="center" valign="top">
								...
								<!--
									...
									-->
								<table border="0" cellpadding="0" cellspacing="0" width="100%" style="color:#FFFFFF;" bgcolor="#448BFF">
									<tr>
										<td align="center" valign="top">
											<!-- FLEXIBLE CONTAINER // -->
											<!--
													...
													<td align="center" valign="top" width="500" class="flexibleContainerCell">
														...
														<table border="0" cellpadding="30" cellspacing="0" width="100%">
															<tr>
																...
																<?php if(!isset($hidelogo)): ?>
																	<img style="margin-bottom:20px;text-align:center;max-width: 400px" src="<?php echo base_url('/assets/logos/logo_liveSupport.png') ?>" alt="">
																<?php endif ?>
																	<h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:28px;font-weight:normal;margin-bottom:5px;text-align:center;"><?php echo $title; ?></h1>
																</td>
															</tr>
														</table>
														<!-- // CONTENT TABLE -->
