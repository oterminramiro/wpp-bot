<?php
    ...
    $this->setCssFile($this->_assetsFolder.'css/grocery-crud-v2.8.1.1dc7094.css');
    ...
    $this->setJavaScriptFile($this->_assetsFolder . 'js/build/grocery-crud-v2.8.1.1dc7094' . $minify_or_not . '.js');
